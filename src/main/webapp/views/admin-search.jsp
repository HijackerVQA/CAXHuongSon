...
<body>
		...
		<div id="main-pane" class="d-flex">
			...
			<div id="right-pane" class="col-lg-10 col-12">
				...
				<div id="btn-land" class="d-flex justify-content-center col-12">
					...
					<a id="btnaddsuspect" class="btn btn-success ml-1 d-flex align-items-center" href="configdata"><i class="material-icons">person_add</i>Thêm đối tượng</a>
				</div>
	...
	<script src="vendor/admin-search.js" type="text/javascript"></script>
</body>
</html>